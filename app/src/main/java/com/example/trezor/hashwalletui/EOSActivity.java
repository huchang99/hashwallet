...
public class EOSActivity extends FragmentActivity {

    private MyValueFragment EosFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EosFragment = new MyValueFragment("EOS","0.00","EOS","0.00");
        transaction.add(R.id.fragment_title ,EosFragment);
        transaction.show(EosFragment);
        transaction.commit();
        ...
        Transferbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(EOSActivity.this,SendActivity.class);
        ...
        Receiptbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //启动收款界面
                Intent intent = new Intent();
                intent.setClass(EOSActivity.this,CollectionMoneyActivity.class);
               // intent.putExtra("TextViewEEE","EOS");
                startActivity(intent);
                intent = null;
            }
